import{_ as i,r as t,o as c,c as o,a as n,d as a,w as e,e as p,b as l}from"./app-2H8C6pDE.js";const r={},d=p(`<h1 id="🐳-docker-部署完整指南" tabindex="-1"><a class="header-anchor" href="#🐳-docker-部署完整指南" aria-hidden="true">#</a> 🐳 Docker 部署完整指南</h1><p>本指南详细介绍如何使用Docker容器化部署Claude Tools + 本地大模型集成系统。</p><h2 id="🎯-部署概览" tabindex="-1"><a class="header-anchor" href="#🎯-部署概览" aria-hidden="true">#</a> 🎯 部署概览</h2><h3 id="系统架构" tabindex="-1"><a class="header-anchor" href="#系统架构" aria-hidden="true">#</a> 系统架构</h3><div class="language-mermaid line-numbers-mode" data-ext="mermaid"><pre class="language-mermaid"><code><span class="token keyword">graph</span> TB
