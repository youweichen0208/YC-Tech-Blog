...
│  └──────────────────────────┘   │
└─────────────────────────────────┘
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>🎯 决策原则：LiteLLM 和模型推理服务要在同一台机器上</strong></p><table><thead><tr><th>模型部署位置</th><th>LiteLLM 安装位置</th><th>Claude CLI 配置</th></tr></thead><tbody><tr><td>本地 Mac</td><td>本地 Mac</td><td><code>http://localhost:8000/v1</code></td></tr><tr><td>云服务器</td><td>云服务器</td><td><code>http://云服务器IP:8000/v1</code></td></tr></tbody></table><h4 id="安装方式" tabindex="-1"><a class="header-anchor" href="#安装方式" aria-hidden="true">#</a> 安装方式</h4><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 方式1：使用 pip 安装（轻量级）</span>
