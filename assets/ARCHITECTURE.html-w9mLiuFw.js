import{_ as t,r as p,o,c as i,a as s,b as n,d as c,w as l,e as a}from"./app-pi6YeQEA.js";const r={},u=a(`<h1 id="wequant-量化交易平台-技术架构文档" tabindex="-1"><a class="header-anchor" href="#wequant-量化交易平台-技术架构文档" aria-hidden="true">#</a> WeQuant 量化交易平台 - 技术架构文档</h1><h2 id="📊-系统总体架构" tabindex="-1"><a class="header-anchor" href="#📊-系统总体架构" aria-hidden="true">#</a> 📊 系统总体架构</h2><h3 id="🏗️-微服务架构图" tabindex="-1"><a class="header-anchor" href="#🏗️-微服务架构图" aria-hidden="true">#</a> 🏗️ 微服务架构图</h3><div class="language-mermaid line-numbers-mode" data-ext="mermaid"><pre class="language-mermaid"><code><span class="token keyword">graph</span> TB
    <span class="token keyword">subgraph</span> <span class="token string">&quot;前端层 Frontend&quot;</span>
        FE<span class="token text string">[Vue.js + Element Plus + ECharts&lt;br/&gt;WebSocket Client]</span>
    ...
    <span class="token keyword">subgraph</span> <span class="token string">&quot;Java微服务集群&quot;</span>
        ...
        SCHED<span class="token text string">[scheduler-service:8085&lt;br/&gt;🆕 智能调度服务]</span>
    <span class="token keyword">end</span>
    ...
    <span class="token keyword">subgraph</span> <span class="token string">&quot;数据存储层&quot;</span>
        ...
        KAFKA<span class="token text string">[(Kafka&lt;br/&gt;消息队列&lt;br/&gt;可选)]</span>
    <span class="token keyword">end</span>

    <span class="token keyword">subgraph</span> <span class="token string">&quot;监控层 Monitoring&quot;</span>
        PROM<span class="token text string">[Prometheus&lt;br/&gt;指标采集]</span>
        GRAF<span class="token text string">[Grafana&lt;br/&gt;可视化]</span>
    <span class="token keyword">end</span>
    ...
    FE <span class="token arrow operator">&lt;--&gt;</span><span class="token label property">|WebSocket|</span> SCHED
    ...
    GW <span class="token arrow operator">--&gt;</span> SCHED
    GW <span class="token arrow operator">--&gt;</span> MDS
    GW <span class="token arrow operator">--&gt;</span> MTS

    SCHED <span class="token arrow operator">--&gt;</span><span class="token label property">|轮询价格|</span> SS
    SCHED <span class="token arrow operator">--&gt;</span><span class="token label property">|策略监控|</span> TS
    SCHED <span class="token arrow operator">--&gt;</span> REDIS
    SCHED <span class="token arrow operator">-.-&gt;</span><span class="token label property">|可选|</span> KAFKA
    ...
    SCHED <span class="token arrow operator">--&gt;</span> PROM
    SS <span class="token arrow operator">--&gt;</span> PROM
    TS <span class="token arrow operator">--&gt;</span> PROM
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_3-🆕-scheduler-service-智能调度服务-8085" tabindex="-1"><a class="header-anchor" href="#_3-🆕-scheduler-service-智能调度服务-8085" aria-hidden="true">#</a> 3. 🆕 Scheduler Service (智能调度服务:8085)</h3><p><strong>技术栈</strong>: Spring Boot + Quartz + WebSocket + AI算法</p>`,29),d=s("strong",null,"详细文档",-1),k=a(`<p><strong>核心职责</strong>:</p><ul><li>🔄 智能分层轮询 (3s/5s/10s/30s)</li><li>🤖 AI驱动的热度检测</li><li>📊 策略实时监控</li><li>⚡ WebSocket实时推送</li><li>📈 性能监控和统计</li></ul><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>scheduler-service/
├── scheduler/
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>AI热度检测算法</strong>:</p><div class="language-java line-numbers-mode" data-ext="java"><pre class="language-java"><code><span class="token comment">// 多维度加权评分 (0-100)</span>
热度评分 <span class="token operator">=</span> 交易量<span class="token punctuation">(</span><span class="token number">30</span><span class="token operator">%</span><span class="token punctuation">)</span> <span class="token operator">+</span> 波动率<span class="token punctuation">(</span><span class="token number">25</span><span class="token operator">%</span><span class="token punctuation">)</span> <span class="token operator">+</span> 价格变化<span class="token punctuation">(</span><span class="token number">20</span><span class="token operator">%</span><span class="token punctuation">)</span>
          <span class="token operator">+</span> 更新频率<span class="token punctuation">(</span><span class="token number">15</span><span class="token operator">%</span><span class="token punctuation">)</span> <span class="token operator">+</span> 时间衰减<span class="token punctuation">(</span><span class="token number">10</span><span class="token operator">%</span><span class="token punctuation">)</span>
          × <span class="token constant">ML</span>增强因子<span class="token punctuation">(</span>时间因子 <span class="token operator">+</span> 趋势因子<span class="token punctuation">)</span>

<span class="token comment">// 自动分类</span>
<span class="token constant">SUPER_HOT</span><span class="token operator">:</span> score ≥ <span class="token number">80</span>  → <span class="token number">3</span>秒更新  ⚡⚡⚡
<span class="token constant">HOT</span><span class="token operator">:</span>       score ≥ <span class="token number">60</span>  → <span class="token number">5</span>秒更新  ⚡⚡
<span class="token constant">NORMAL</span><span class="token operator">:</span>    score ≥ <span class="token number">30</span>  → <span class="token number">10</span>秒更新 ⚡
<span class="token constant">COLD</span><span class="token operator">:</span>      score <span class="token operator">&lt;</span> <span class="token number">30</span>  → <span class="token number">30</span>秒更新
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>WebSocket推送</strong>:</p><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token comment">// 前端订阅实时价格</span>
...
<span class="token comment">// 订阅交易信号</span>
...
<span class="token punctuation">}</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>性能指标</strong>:</p><ul><li>并行处理性能提升: <strong>5倍</strong> (1000ms → 200ms)</li><li>Redis缓存命中率: <strong>&gt;90%</strong></li><li>系统更新成功率: <strong>99.9%+</strong></li><li>支持监控股票数: <strong>1000+</strong></li></ul><p><strong>监控端点</strong>:</p><div class="language-http line-numbers-mode" data-ext="http"><pre class="language-http"><code>GET /api/v1/scheduler/metrics          # 性能指标
GET /api/v1/scheduler/hotness/ranking  # AI热度排行
GET /api/v1/scheduler/status           # 调度器状态
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><hr><h3 id="_4-python-服务集群" tabindex="-1"><a class="header-anchor" href="#_4-python-服务集群" aria-hidden="true">#</a> 4. Python 服务集群</h3><h4 id="_3-1-市场数据服务-market-data-service-5001" tabindex="-1"><a class="header-anchor" href="#_3-1-市场数据服务-market-data-service-5001" aria-hidden="true">#</a> 3.1 市场数据服务 (market-data-service:5001)</h4><p><strong>技术栈</strong>: FastAPI + akshare + asyncio + Redis</p><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code>market<span class="token operator">-</span>data<span class="token operator">-</span>service<span class="token operator">/</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><hr><p><em>最后更新: 2025-10-17</em><em>架构版本: V2.0 - 微服务 + 虚拟交易</em></p>`,51);function v(m,b){const e=p("RouterLink");return o(),i("div",null,[u,s("blockquote",null,[s("p",null,[n("📘 "),d,n(": "),c(e,{to:"/quant-platform/SCHEDULER_SERVICE.html"},{default:l(()=>[n("Scheduler Service 完整技术文档")]),_:1})])]),k])}const y=t(r,[["render",v],["__file","ARCHITECTURE.html.vue"]]);export{y as default};
