import{_ as i,r as t,o as c,c as o,a as n,d as a,w as e,e as p,b as l}from"./app-Umcqr2fY.js";const r={},d=p(`<h1 id="🐳-docker-部署完整指南" tabindex="-1"><a class="header-anchor" href="#🐳-docker-部署完整指南" aria-hidden="true">#</a> 🐳 Docker 部署完整指南</h1><p>本指南详细介绍如何使用Docker容器化部署Claude Tools + 本地大模型集成系统。</p><h2 id="🎯-部署概览" tabindex="-1"><a class="header-anchor" href="#🎯-部署概览" aria-hidden="true">#</a> 🎯 部署概览</h2><h3 id="系统架构" tabindex="-1"><a class="header-anchor" href="#系统架构" aria-hidden="true">#</a> 系统架构</h3><div class="language-mermaid line-numbers-mode" data-ext="mermaid"><pre class="language-mermaid"><code><span class="token keyword">graph</span> TB
    <span class="token keyword">subgraph</span> <span class="token string">&quot;Docker 容器集群&quot;</span>
        A<span class="token text string">[claude-local-llm-proxy&lt;br/&gt;代理服务容器]</span> <span class="token arrow operator">--&gt;</span> B<span class="token text string">[claude-ollama&lt;br/&gt;模型运行容器]</span>
        A <span class="token arrow operator">--&gt;</span> C<span class="token text string">[claude-redis&lt;br/&gt;缓存容器]</span>
        A <span class="token arrow operator">--&gt;</span> D<span class="token text string">[claude-prometheus&lt;br/&gt;监控容器]</span>
        D <span class="token arrow operator">--&gt;</span> E<span class="token text string">[claude-grafana&lt;br/&gt;可视化容器]</span>
    <span class="token keyword">end</span>

    <span class="token keyword">subgraph</span> <span class="token string">&quot;Claude Tools&quot;</span>
        F<span class="token text string">[Claude Code CLI]</span> <span class="token arrow operator">--&gt;</span> A
    <span class="token keyword">end</span>

    <span class="token keyword">subgraph</span> <span class="token string">&quot;AI 模型&quot;</span>
        B <span class="token arrow operator">--&gt;</span> G<span class="token text string">[Llama 3.1 8B]</span>
        B <span class="token arrow operator">--&gt;</span> H<span class="token text string">[Qwen 2.5 7B]</span>
        B <span class="token arrow operator">--&gt;</span> I<span class="token text string">[DeepSeek Coder 6.7B]</span>
    <span class="token keyword">end</span>
...
<span class="token function">curl</span> http://localhost:8000/health
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="📚-相关文档" tabindex="-1"><a class="header-anchor" href="#📚-相关文档" aria-hidden="true">#</a> 📚 相关文档</h2>`,75),u=n("hr",null,null,-1),m=n("p",null,[n("em",null,"Docker部署方式为Claude Tools + 本地大模型提供了企业级的稳定性和可扩展性，是推荐的生产环境部署方案。")],-1);function v(k,b){const s=t("RouterLink");return c(),o("div",null,[d,n("ul",null,[n("li",null,[a(s,{to:"/ai-tools/LOCAL_LLM_ARCHITECTURE.html"},{default:e(()=>[l("🏗️ 系统架构详解")]),_:1})]),n("li",null,[a(s,{to:"/ai-tools/QUICKSTART.html"},{default:e(()=>[l("⚡ 快速开始指南")]),_:1})]),n("li",null,[a(s,{to:"/ai-tools/CODE_OVERVIEW.html"},{default:e(()=>[l("💻 代码总览")]),_:1})])]),u,m])}const g=i(r,[["render",v],["__file","DOCKER_DEPLOYMENT.html.vue"]]);export{g as default};
