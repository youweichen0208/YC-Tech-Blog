import{_ as l,r as i,o as t,c as o,a as n,b as s,d as c,w as p,e as a}from"./app-2YAOz1z_.js";const r={},d=a(`<h1 id="🐳-claude-tools-本地大模型-docker-快速部署指南" tabindex="-1"><a class="header-anchor" href="#🐳-claude-tools-本地大模型-docker-快速部署指南" aria-hidden="true">#</a> 🐳 Claude Tools + 本地大模型 Docker 快速部署指南</h1><p>这是一个<strong>5分钟快速部署指南</strong>，帮助你通过 Docker 容器化方式部署 Claude Tools 与本地大模型集成系统。</p><h2 id="📋-前置要求" tabindex="-1"><a class="header-anchor" href="#📋-前置要求" aria-hidden="true">#</a> 📋 前置要求</h2><h3 id="系统要求" tabindex="-1"><a class="header-anchor" href="#系统要求" aria-hidden="true">#</a> 系统要求</h3><ul><li><strong>Docker Desktop</strong> 4.20+</li><li><strong>内存</strong>: 8GB+（推荐16GB+）</li><li><strong>存储</strong>: 20GB+ 可用空间</li><li><strong>平台</strong>: Mac M1/M2、Linux x86_64、Windows WSL2</li></ul><h3 id="docker-环境检查" tabindex="-1"><a class="header-anchor" href="#docker-环境检查" aria-hidden="true">#</a> Docker 环境检查</h3><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 检查 Docker 版本</span>
